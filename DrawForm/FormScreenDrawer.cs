...
namespace DrawForm
{
    public partial class FormScreenDrawer : Form, IScreenDrawer
    {
        ...
        public void Draw(Vector4[,] frameBuffer, string message)
        {
            ...
            //var font = new Font("Î¢ÈíÑÅºÚ", 70f, FontStyle.Bold);
            //_graphics.DrawString("×£½ã½ã18ËêÉúÈÕ¿ìÀÖ", font, new SolidBrush(Color.Pink), new PointF((Width / 2) - (font.Size * 6.5f), Height - 200));
        }
